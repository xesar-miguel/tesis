...
public class CategorizacionException extends Exception {
	...
	// constructores
	public CategorizacionException(String mensaje) {
		this("default-type-error", mensaje, "default-error-code");
	}

	public CategorizacionException(String mensaje, String codigo) {
		this("default-type-error", mensaje, codigo);
	}

	public CategorizacionException(String tipo, String mensaje, String codigo) {
		this("default-type-error", mensaje, codigo, null);
	}
	public CategorizacionException(String tipo, String mensaje, String codigo, Object extra) {
		super(mensaje);
		this.tipo = tipo;
