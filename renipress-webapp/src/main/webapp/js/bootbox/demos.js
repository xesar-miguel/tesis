...
$(function () {
    ...
    demos.alert_callback = function () {
        bootbox.alert("Hello world!", function () {
            Renipress.show("Hello world callback");
        });
    };

    demos.confirm = function () {
        bootbox.confirm("Are you sure?", function (result) {
            Renipress.show("Confirm result: " + result);
        });
    };
    ...
    demos.confirm_buttons = function () {
        bootbox.confirm("This confirm has custom buttons - see?", "No", "Yes!", function (result) {
            if (result) {
                Renipress.show("Well done!");
            } else {
                Renipress.show("Oh no - try again!");
            }
        });
    };
    ...
    demos.prompt = function () {
        bootbox.prompt("What is your name?", function (result) {
            if (result === null) {
                Renipress.show("Prompt dismissed");
            } else {
                Renipress.show("Hi <b>" + result + "</b>");
            }
        });
    };
            ...
            buttons: {
                success: {
                    ...
                    callback: function () {
                        ...
                        Renipress.show("Hello " + name + ". You've chosen <b>" + answer + "</b>");
                    }
                }
            }
        }
