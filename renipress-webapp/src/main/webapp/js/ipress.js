...
function ActualizarSolicitud(idSolConsultar, idOpcion) {
    beginCargando();
    $.getJSON("solicitud.htm?action=cargarConsultaSolicitudJSON&idSol=" + idSolConsultar, function (data) {
        idopcionValidar = idOpcion;
        //console.log("idopcionValidar " + idopcionValidar);
        objSolicitud = data;
        //-----INICIO DATOS PRIMERA PESTAÃ‘A
        ...
        //-----FIN DATOS PRIMERA PESTAÃ‘A

	if (objSolicitudDS.TI_PERSONAPROP_SI != undefined && objSolicitudDS.TI_PERSONAPROP_SI != ''){
		activarTab(false);
	}else{
		activarTab(true);
	}
        ...
        //el alias TI_TIPODOC_PP esta en el SP pero no lo retorna.
        ...
        //--Datos del Representante Legal---------------        
            ...
            if (objSolicitudDS.FLAG_NU_SERIEESTABL_SI != "5"&&objSolicitudDS.FLAG_NU_SERIEESTABL_SI != "1"&&objSolicitudDS.FLAG_NU_SERIEESTABL_SI != "0"&&objSolicitudDS.FLAG_NU_SERIEESTABL_SI!== undefined) {
                $('#txtNuSerieDE').addClass("bg-campo-editado");
            }
        ...
        //--Datos DISA/DIRESA/GERESA, INSTITUCIÃ“N A LA QUE PERTENECE (*), REDES y MICROREDES
        if (objSolicitudDS.FLAG_CO_AUTSANITARIA_SI != "5"&&objSolicitudDS.FLAG_CO_AUTSANITARIA_SI != "1"&&objSolicitudDS.FLAG_CO_AUTSANITARIA_SI != "0"&&objSolicitudDS.FLAG_CO_AUTSANITARIA_SI!== undefined) {
            $("#cboAutSanitaria").addClass("bg-campo-editado");
        }
        ...
        //---Datos del Director Médico o Representante de la Atención de Salud------------------------
            ...
            //----Datos Adicionales-------------------------
        //add 06-01
        if (objSolicitudDS.FLAG_NU_AMBIENTESTABL_SI != "5"&&objSolicitudDS.FLAG_NU_AMBIENTESTABL_SI != "1"&&objSolicitudDS.FLAG_NU_AMBIENTESTABL_SI != "0"&&objSolicitudDS.FLAG_NU_AMBIENTESTABL_SI!== undefined) {
            $('#txtNroEstDA').addClass("bg-campo-editado");
        }
            $('#txtNroEstDA').val(objSolicitudDS.NU_AMBIENTESTABL_SI);
            
        if (objSolicitudDS.FLAG_DE_HORAATENC_SI != "5"&&objSolicitudDS.FLAG_DE_HORAATENC_SI != "1"&&objSolicitudDS.FLAG_DE_HORAATENC_SI != "0"&&objSolicitudDS.FLAG_DE_HORAATENC_SI!== undefined) {
            $('#txtHorarioAtenDA').addClass("bg-campo-editado");
                          }
        $('#txtHorarioAtenDA').val(objSolicitudDS.DE_HORARIOATENCION_SI);

        if (objSolicitudDS.FLAG_DE_CAMPOCLINICO_SI != "5"&&objSolicitudDS.FLAG_DE_CAMPOCLINICO_SI !="1"&&objSolicitudDS.FLAG_DE_CAMPOCLINICO_SI !="0"&&objSolicitudDS.FLAG_DE_CAMPOCLINICO_SI!== undefined) {
            $('#txtCampoClinicoDA').addClass("bg-campo-editado");
        }
        $('#txtCampoClinicoDA').val(objSolicitudDS.DE_CAMPOCLINICO_SI);
		
        if (objSolicitudDS.FLAG_DE_POBLASIGNADA_SI != "5"&&objSolicitudDS.FLAG_DE_POBLASIGNADA_SI != "1"&&objSolicitudDS.FLAG_DE_POBLASIGNADA_SI != "0"&&objSolicitudDS.FLAG_DE_POBLASIGNADA_SI!== undefined) {
            $('#txtEspecificarDA').addClass("bg-campo-editado");
		}
        ...
        //DATOS DE PERSAONA JURIDICA        
        if (objSolicitudDS.FLAG_NU_RUCPROP_SI != "5"&&objSolicitudDS.FLAG_NU_RUCPROP_SI != "1"&&objSolicitudDS.FLAG_NU_RUCPROP_SI != "0"&&objSolicitudDS.FLAG_NU_RUCPROP_SI!== undefined) {
            $('#txtRucPJRA').addClass("bg-campo-editado");
        }
        $('#txtRucPJRA').val(objSolicitudDS.NU_RUCPROP_SI);

        if (objSolicitudDS.FLAG_DE_RAZONSOCIALPROP_SI != "5"&&objSolicitudDS.FLAG_DE_RAZONSOCIALPROP_SI != "1"&&objSolicitudDS.FLAG_DE_RAZONSOCIALPROP_SI != "0"&&objSolicitudDS.FLAG_DE_RAZONSOCIALPROP_SI!== undefined) {
            $('#txtRSocialPJRA').addClass("bg-campo-editado");
        }
        $('#txtRSocialPJRA').val(objSolicitudDS.DE_RAZONSOCIALPROP_SI);

        if (objSolicitudDS.FLAG_NO_COMERCIALPROP_SI != "5"&&objSolicitudDS.FLAG_NO_COMERCIALPROP_SI != "1"&&objSolicitudDS.FLAG_NO_COMERCIALPROP_SI != "0"&&objSolicitudDS.FLAG_NO_COMERCIALPROP_SI!== undefined) {
            $('#txtNComercialPJRA').addClass("bg-campo-editado");
        }
        ...
        if (objSolicitudDS.FLAG_DE_VIA_DP != "5"&&objSolicitudDS.FLAG_DE_VIA_DP != "1"&&objSolicitudDS.FLAG_DE_VIA_DP != "0"&&objSolicitudDS.FLAG_DE_VIA_DP!== undefined) {
            $('#cboViaNombreRA').addClass("bg-campo-editado");
        }
        $('#cboViaNombreRA').val(objSolicitudDS.DE_VIA_DP);

        if (objSolicitudDS.FLAG_NU_NUMERO_DP != "5"&&objSolicitudDS.FLAG_NU_NUMERO_DP != "1"&&objSolicitudDS.FLAG_NU_NUMERO_DP != "0"&&objSolicitudDS.FLAG_NU_NUMERO_DP!== undefined) {
            $('#txtNroRA').addClass("bg-campo-editado");
        }
        $('#txtNroRA').val(objSolicitudDS.NU_NUMERO_DP);

        if (objSolicitudDS.FLAG_NU_PISO_DP != "5"&&objSolicitudDS.FLAG_NU_PISO_DP != "1"&&objSolicitudDS.FLAG_NU_PISO_DP != "0"&&objSolicitudDS.FLAG_NU_PISO_DP!== undefined) {
            $('#txtNroPisoRA').addClass("bg-campo-editado");
        }
        $('#txtNroPisoRA').val(objSolicitudDS.NU_PISO_DP);

        if (objSolicitudDS.FLAG_NU_DEPARTAMENTO_DP != "5"&&objSolicitudDS.FLAG_NU_DEPARTAMENTO_DP != "1"&&objSolicitudDS.FLAG_NU_DEPARTAMENTO_DP != "0"&&objSolicitudDS.FLAG_NU_DEPARTAMENTO_DP!== undefined) {
            $('#txtNroPisoRA').addClass("bg-campo-editado");
        }
        $('#txtNroDptoRA').val(objSolicitudDS.NU_DEPARTAMENTO_DP);

        if (objSolicitudDS.FLAG_NU_INTERIOR_DP != "5"&&objSolicitudDS.FLAG_NU_INTERIOR_DP != "1"&&objSolicitudDS.FLAG_NU_INTERIOR_DP != "0"&&objSolicitudDS.FLAG_NU_INTERIOR_DP!== undefined) {
            $('#txtInteriorRA').addClass("bg-campo-editado");
        }
        $('#txtInteriorRA').val(objSolicitudDS.NU_INTERIOR_DP);

        if (objSolicitudDS.FLAG_DE_MANZANA_DP != "5"&&objSolicitudDS.FLAG_DE_MANZANA_DP != "1"&&objSolicitudDS.FLAG_DE_MANZANA_DP != "0"&&objSolicitudDS.FLAG_DE_MANZANA_DP!== undefined) {
            $('#txtManzanaRA').addClass("bg-campo-editado");
        }
        $('#txtManzanaRA').val(objSolicitudDS.DE_MANZANA_DP);

        if (objSolicitudDS.FLAG_DE_LOTE_DP != "5"&&objSolicitudDS.FLAG_DE_LOTE_DP != "1"&&objSolicitudDS.FLAG_DE_LOTE_DP != "0"&&objSolicitudDS.FLAG_DE_LOTE_DP!== undefined) {
            $('#txtLoteRA').addClass("bg-campo-editado");
        }
        $('#txtLoteRA').val(objSolicitudDS.DE_LOTE_DP);

        if (objSolicitudDS.FLAG_DE_KILOMETRO_DP != "5"&&objSolicitudDS.FLAG_DE_KILOMETRO_DP != "1"&&objSolicitudDS.FLAG_DE_KILOMETRO_DP != "0"&&objSolicitudDS.FLAG_DE_KILOMETRO_DP!== undefined) {
            $('#txtKmRA').addClass("bg-campo-editado");
        }
        $('#txtKmRA').val(objSolicitudDS.DE_KILOMETRO_DP);

        if (objSolicitudDS.FLAG_DE_URBANIZ_DP != "5"&&objSolicitudDS.FLAG_DE_URBANIZ_DP != "1"&&objSolicitudDS.FLAG_DE_URBANIZ_DP != "0"&&objSolicitudDS.FLAG_DE_URBANIZ_DP!== undefined) {
            $('#txtUrRA').addClass("bg-campo-editado");
        }
        $('#txtUrRA').val(objSolicitudDS.DE_URBANIZ_DP);

        if (objSolicitudDS.FLAG_DE_REFERENCIA_DP != "5"&&objSolicitudDS.FLAG_DE_REFERENCIA_DP != "1"&&objSolicitudDS.FLAG_DE_REFERENCIA_DP != "0"&&objSolicitudDS.FLAG_DE_REFERENCIA_DP!== undefined) {
            $('#txtRefRA').addClass("bg-campo-editado");
        }
        $('#txtRefRA').val(objSolicitudDS.DE_REFERENCIA_DP);


        /*modificacion*/
        if (objSolicitudDS.FLAG_NU_TELEFONOPROP_SI != "5"&&objSolicitudDS.FLAG_NU_TELEFONOPROP_SI != "1"&&objSolicitudDS.FLAG_NU_TELEFONOPROP_SI != "0"&&objSolicitudDS.FLAG_NU_TELEFONOPROP_SI!== undefined) {
            $('#txtTelRA').addClass("bg-campo-editado");
        }
        $('#txtTelRA').val(objSolicitudDS.NU_TELEFONOPROP_SI);

        if (objSolicitudDS.FLAG_NU_FAXPROP_SI != "5"&&objSolicitudDS.FLAG_NU_FAXPROP_SI != "1"&&objSolicitudDS.FLAG_NU_FAXPROP_SI != "0"&&objSolicitudDS.FLAG_NU_FAXPROP_SI!== undefined) {
            $('#txtFaxRA').addClass("bg-campo-editado");
        }
        $('#txtFaxRA').val(objSolicitudDS.NU_FAXPROP_SI);

        if (objSolicitudDS.FLAG_DE_CORREOELECTRPROP_SI != "5"&&objSolicitudDS.FLAG_DE_CORREOELECTRPROP_SI != "1"&&objSolicitudDS.FLAG_DE_CORREOELECTRPROP_SI != "0"&&objSolicitudDS.FLAG_DE_CORREOELECTRPROP_SI!== undefined) {
            $('#txtEmailRA').addClass("bg-campo-editado");
            $('#panelDatosPropietario').addClass("active");//panel
        }
        $('#txtEmailRA').val(objSolicitudDS.DE_CORREOELECTRPROP_SI);

        if (objSolicitudDS.FLAG_DE_CORREOELECTRPROP_SI != "5"&&objSolicitudDS.FLAG_DE_CORREOELECTRPROP_SI != "1"&&objSolicitudDS.FLAG_DE_CORREOELECTRPROP_SI != "0"&&objSolicitudDS.FLAG_DE_CORREOELECTRPROP_SI!== undefined) {
            $('#txtReEmailRA').addClass("bg-campo-editado");
        }
        $('#txtReEmailRA').val(objSolicitudDS.DE_CORREOELECTRPROP_SI);

        if (objSolicitudDS.FLAG_DE_PAGINAWEBPROP_SI != "5"&&objSolicitudDS.FLAG_DE_PAGINAWEBPROP_SI != "1"&&objSolicitudDS.FLAG_DE_PAGINAWEBPROP_SI != "0"&&objSolicitudDS.FLAG_DE_PAGINAWEBPROP_SI!== undefined) {
            $('#txtWebRA').addClass("bg-campo-editado");
        }
        $('#txtWebRA').val(objSolicitudDS.DE_PAGINAWEBPROP_SI);
        ...
        $('#txtEmailRRLL').val(objSolicitudDS.DE_CORREOELECTRREPLEGAL_SI);
        $('#txtReEmailRRLL').val(objSolicitudDS.DE_CORREOELECTRREPLEGAL_SI);
        if (objSolicitudDS.FLAG_CAMBIO_REPRE_LEGAL != "5"&&objSolicitudDS.FLAG_CAMBIO_REPRE_LEGAL != "1"&&objSolicitudDS.FLAG_CAMBIO_REPRE_LEGAL != "0"&&objSolicitudDS.FLAG_CAMBIO_REPRE_LEGAL!== undefined) {
            $("#divMensajeRepreLegal").css("display", "block");
        }

        if (objSolicitudDS.FLAG_NO_RAZONSOCIALESTAB_SI != "5"&&objSolicitudDS.FLAG_NO_RAZONSOCIALESTAB_SI != "1"&&objSolicitudDS.FLAG_NO_RAZONSOCIALESTAB_SI != "0"&&objSolicitudDS.FLAG_NO_RAZONSOCIALESTAB_SI!== undefined) {
            $("#txtRazonSocialDE").addClass("bg-campo-editado");
        }
        $('#txtRazonSocialDE').val(objSolicitudDS.NO_RAZONSOCIALESTABL_SI);

        if (objSolicitudDS.FLAG_NO_COMERCIALESTABL_SI != "5"&&objSolicitudDS.FLAG_NO_COMERCIALESTABL_SI != "1"&&objSolicitudDS.FLAG_NO_COMERCIALESTABL_SI != "0"&&objSolicitudDS.FLAG_NO_COMERCIALESTABL_SI!== undefined) {
            $("#txtNComercialDE").addClass("bg-campo-editado");
        }
        $('#txtNComercialDE').val(objSolicitudDS.NO_COMERCIALESTABL_SI);
        //------------------------------------------------------------------------
        if (objSolicitudDS.FLAG_DE_VIA_DE != "5"&&objSolicitudDS.FLAG_DE_VIA_DE != "1"&&objSolicitudDS.FLAG_DE_VIA_DE != "0"&&objSolicitudDS.FLAG_DE_VIA_DE!== undefined) {
            $("#txtViaDetDE").addClass("bg-campo-editado");
        }
        $('#txtViaDetDE').val(objSolicitudDS.DE_VIA_DE);

        if (objSolicitudDS.FLAG_NU_NUMERO_DE != "5"&&objSolicitudDS.FLAG_NU_NUMERO_DE != "0"&&objSolicitudDS.FLAG_NU_NUMERO_DE != "1"&&objSolicitudDS.FLAG_NU_NUMERO_DE!== undefined) {
            $("#txtNroDE").addClass("bg-campo-editado");
        }
        $('#txtNroDE').val(objSolicitudDS.NU_NUMERO_DE);

        if (objSolicitudDS.FLAG_NU_PISO_DE != "5"&&objSolicitudDS.FLAG_NU_PISO_DE != "1"&&objSolicitudDS.FLAG_NU_PISO_DE != "0"&&objSolicitudDS.FLAG_NU_PISO_DE!== undefined) {
            $("#txtNroPisoDE").addClass("bg-campo-editado");
        }
        $('#txtNroPisoDE').val(objSolicitudDS.NU_PISO_DE);

        if (objSolicitudDS.FLAG_NU_DEPARTAMENTO_DE != "5"&&objSolicitudDS.FLAG_NU_DEPARTAMENTO_DE != "1"&&objSolicitudDS.FLAG_NU_DEPARTAMENTO_DE != "0"&&objSolicitudDS.FLAG_NU_DEPARTAMENTO_DE!== undefined) {
            $("#txtNroDepDE").addClass("bg-campo-editado");
        }
        $('#txtNroDepDE').val(objSolicitudDS.NU_DEPARTAMENTO_DE);

        if (objSolicitudDS.FLAG_NU_INTERIOR_DE != "5"&&objSolicitudDS.FLAG_NU_INTERIOR_DE != "1"&&objSolicitudDS.FLAG_NU_INTERIOR_DE != "0"&&objSolicitudDS.FLAG_NU_INTERIOR_DE!== undefined) {
            $("#txtNroIntDE").addClass("bg-campo-editado");
        }
        $('#txtNroIntDE').val(objSolicitudDS.NU_INTERIOR_DE);

        if (objSolicitudDS.FLAG_DE_MANZANA_DE != "5"&&objSolicitudDS.FLAG_DE_MANZANA_DE != "1"&&objSolicitudDS.FLAG_DE_MANZANA_DE != "0"&&objSolicitudDS.FLAG_DE_MANZANA_DE!== undefined) {
            $("#txtMzDE").addClass("bg-campo-editado");
        }
        $('#txtMzDE').val(objSolicitudDS.DE_MANZANA_DE);

        if (objSolicitudDS.FLAG_DE_LOTE_DE != "5"&&objSolicitudDS.FLAG_DE_LOTE_DE != "1"&&objSolicitudDS.FLAG_DE_LOTE_DE != "0"&&objSolicitudDS.FLAG_DE_LOTE_DE!== undefined) {
            $("#txtLtDE").addClass("bg-campo-editado");
        }
        $('#txtLtDE').val(objSolicitudDS.DE_LOTE_DE);

        if (objSolicitudDS.FLAG_DE_KILOMETRO_DE != "5"&&objSolicitudDS.FLAG_DE_KILOMETRO_DE != "1"&&objSolicitudDS.FLAG_DE_KILOMETRO_DE != "0"&&objSolicitudDS.FLAG_DE_KILOMETRO_DE!== undefined) {
            $("#txtKlDE").addClass("bg-campo-editado");
        }
        $('#txtKlDE').val(objSolicitudDS.DE_KILOMETRO_DE);

        if (objSolicitudDS.FLAG_DE_URBANIZ_DE != "5"&&objSolicitudDS.FLAG_DE_URBANIZ_DE != "1"&&objSolicitudDS.FLAG_DE_URBANIZ_DE != "0"&&objSolicitudDS.FLAG_DE_URBANIZ_DE!== undefined) {
            $("#txtUrDE").addClass("bg-campo-editado");
        }
        $('#txtUrDE').val(objSolicitudDS.DE_URBANIZ_DE);

        if (objSolicitudDS.FLAG_DE_REFERENCIA_DE != "5"&&objSolicitudDS.FLAG_DE_REFERENCIA_DE != "1"&&objSolicitudDS.FLAG_DE_REFERENCIA_DE != "0"&&objSolicitudDS.FLAG_DE_REFERENCIA_DE!== undefined) {
            $("#txtRefDE").addClass("bg-campo-editado");
        }
        $('#txtRefDE').val(objSolicitudDS.DE_REFERENCIA_DE);
        ...
        if (objSolicitudDS.FLAG_NU_TELEFONOESTABL_SI != "5"&&objSolicitudDS.FLAG_NU_TELEFONOESTABL_SI != "1"&&objSolicitudDS.FLAG_NU_TELEFONOESTABL_SI != "0"&&objSolicitudDS.FLAG_NU_TELEFONOESTABL_SI!== undefined) {
            $('#txtTelDatosDE').addClass("bg-campo-editado");
                }
        $('#txtTelDatosDE').val(objSolicitudDS.NU_TELEFONOESTABL_SI);
		
        if (objSolicitudDS.FLAG_NU_TLFEMERGESTABL_SI != "5"&&objSolicitudDS.FLAG_NU_TLFEMERGESTABL_SI != "1"&&objSolicitudDS.FLAG_NU_TLFEMERGESTABL_SI != "0"&&objSolicitudDS.FLAG_NU_TLFEMERGESTABL_SI!== undefined) {
            $('#txtTelEmerDatosDE').addClass("bg-campo-editado");
        }
        $('#txtTelEmerDatosDE').val(objSolicitudDS.NU_TELEFONOEMERGESTABL_SI);

        if (objSolicitudDS.FLAG_DE_RADIOESTABL_SI != "5"&&objSolicitudDS.FLAG_DE_RADIOESTABL_SI != "1"&&objSolicitudDS.FLAG_DE_RADIOESTABL_SI != "0"&&objSolicitudDS.FLAG_DE_RADIOESTABL_SI!== undefined) {
            $('#txtRadioDatosDE').addClass("bg-campo-editado");
        }
        $('#txtRadioDatosDE').val(objSolicitudDS.DE_RADIOESTABL_SI);

        if (objSolicitudDS.FLAG_NU_FAXESTABL_SI != "5"&&objSolicitudDS.FLAG_NU_FAXESTABL_SI != "1"&&objSolicitudDS.FLAG_NU_FAXESTABL_SI != "0"&&objSolicitudDS.FLAG_NU_FAXESTABL_SI!== undefined) {
            $('#txtFaxDatosDE').addClass("bg-campo-editado");
        }
        $('#txtFaxDatosDE').val(objSolicitudDS.NU_FAXESTABL_SI);

        if (objSolicitudDS.FLAG_DE_CORREOESTABL_SI != "5"&&objSolicitudDS.FLAG_DE_CORREOESTABL_SI != "1"&&objSolicitudDS.FLAG_DE_CORREOESTABL_SI != "0"&&objSolicitudDS.FLAG_DE_CORREOESTABL_SI!== undefined) {
            $('#txtEmailDatosDE').addClass("bg-campo-editado");
        }
        $('#txtEmailDatosDE').val(objSolicitudDS.DE_CORREOELECTRESTABL_SI);

        //if (objSolicitudDS.FLAG_DE_CORREOELECTRESTABL_SI != "5"&&objSolicitudDS.FLAG_DE_CORREOELECTRESTABL_SI != "1"&&objSolicitudDS.FLAG_DE_CORREOELECTRESTABL_SI != "0") {
        if (objSolicitudDS.FLAG_DE_CORREOESTABL_SI != "5"&&objSolicitudDS.FLAG_DE_CORREOESTABL_SI != "1"&&objSolicitudDS.FLAG_DE_CORREOESTABL_SI != "0"&&objSolicitudDS.FLAG_DE_CORREOESTABL_SI!== undefined) {        
            $('#txtReEmailDatosDE').addClass("bg-campo-editado");
        }
        $('#txtReEmailDatosDE').val(objSolicitudDS.DE_CORREOELECTRESTABL_SI);

        if (objSolicitudDS.FLAG_DE_PAGWEBESTABL_SI != "5"&&objSolicitudDS.FLAG_DE_PAGWEBESTABL_SI != "1"&&objSolicitudDS.FLAG_DE_PAGWEBESTABL_SI != "0"&&objSolicitudDS.FLAG_DE_PAGWEBESTABL_SI!== undefined) {
            $('#txtWebDatosDE').addClass("bg-campo-editado");
        }
        $('#txtWebDatosDE').val(objSolicitudDS.DE_PAGINAWEBESTABL_SI);

        if (objSolicitudDS.FLAG_FE_FECINICESTABL_SI != "5"&&objSolicitudDS.FLAG_FE_FECINICESTABL_SI != "1"&&objSolicitudDS.FLAG_FE_FECINICESTABL_SI != "0"&&objSolicitudDS.FLAG_FE_FECINICESTABL_SI!== undefined) {
            $('#txtFecIniDatosDE').addClass("bg-campo-editado");
        }
        $('#txtFecIniDatosDE').val(objSolicitudDS.FE_FECHAINICACTESTABL_SI);

        if (objSolicitudDS.FLAG_FE_FECHACREAESTABL_SI != "5"&&objSolicitudDS.FLAG_FE_FECHACREAESTABL_SI != "1"&&objSolicitudDS.FLAG_FE_FECHACREAESTABL_SI != "0"&&objSolicitudDS.FLAG_FE_FECHACREAESTABL_SI!== undefined) {
            $('#txtFecCreacionDatosDE').addClass("bg-campo-editado");
        }
        $('#txtFecCreacionDatosDE').val(objSolicitudDS.FE_FECHACREACIONESTABL_SI);

        if (objSolicitudDS.FLAG_NU_RESOLESTABL_SI != "5"&&objSolicitudDS.FLAG_NU_RESOLESTABL_SI != "1"&&objSolicitudDS.FLAG_NU_RESOLESTABL_SI != "0"&&objSolicitudDS.FLAG_NU_RESOLESTABL_SI!== undefined) {
            $('#txtNroResolDatosDE').addClass("bg-campo-editado");
        }
        $('#txtNroResolDatosDE').val(objSolicitudDS.NU_RESOLUCIONESTABL_SI);
        ...
        $('#txtEmailRAS').val(objSolicitudDS.DE_CORREOELECTRDIRMED_SI);
        $('#txtReEmailRAS').val(objSolicitudDS.DE_CORREOELECTRDIRMED_SI);
        if (objSolicitudDS.FLAG_CAMBIO_DIR_MED != "5"&&objSolicitudDS.FLAG_CAMBIO_DIR_MED != "1"&&objSolicitudDS.FLAG_CAMBIO_DIR_MED != "0"&&objSolicitudDS.FLAG_CAMBIO_DIR_MED!== undefined) {
            $("#divMensajeDirMedicoRepre").css("display", "block");
        }
        //------------------------------------------------
...
function ValidarDNI4() {
    ...
    try {
        if ($('#txtNroDocExcel').val() !== '' && $('#CboSexoExcel').val() !== '' && $('#txtFecNacExcel').val() !== '') {
            $.ajax({
                url: "solicitud.htm?action=selectDNI&dni=" + $('#txtNroDocExcel').val() + "&sexo=" + $('#CboSexoExcel').val() + "&fecNac=" + $('#txtFecNacExcel').val() + "&cboDocumento=" + $('#cboTipoDocExcel').val(),
                dataType: "json",
                success: function (result) {
                    if (result.preNombres === undefined) {
                ...
                if ($(this).data('value') === 1) {
                    ...
                    $.ajax({
                        ...
                        success: function (
                            ...
                            $('#lblConenidoPopGenerico').text('Se ha registrado la información de solicitud. Puede continuar con el Registro de Datos Generales');
...
function ValidarFormularios() {
	...
	if (arrClasEst.length === 0) {
		$('#checkEstOK').hide();
		$('#checkEstNoOK').show();
		$('#lblclasificacion1').attr('style', 'color:red');
		$('#lblclasificacion2').attr('style', 'color:red');
		resp = false;
	} else {
		$('#checkEstOK').show();
		$('#checkEstNoOK').hide();
		$('#lblclasificacion1').attr('style', 'color:black');	
		$('#lblclasificacion2').attr('style', 'color:black');
	}
    }
    ...
    $('#popConfirmaGuardarSolicitud').modal({
        ...
        if ($(this).data('value') === 1) {
			...
			if (valDireccionEst() == 1){
				var validacionDirector = valDirectorMedico();
				if (validacionDirector.p_nFLAG_VALIDAR == 0){
                ConfirmaGuardarIpress();
				}else{
					LanzarPopGenerico('Informativo', 'El director  medico ya se encuentra registrado en las siguiente IPRESS: ' + validacionDirector.p_vIPRESS, 
						function(){
							$('#txtNroDocRAS').focus(100);
						});
                return false;
            }
			}else{
...
function GuardarIpressRequisito() {
  ...
  //VALIDACION DE CANTIDAD DE REQUISITOS
    ...
    if (RetornaObjTabla('datable-grilla40').length == 0){
	LanzarPopGenerico("Informativo", "Es necesario que seleccione una UPSS.");
    	return false;
    }
...
function MostrarEstablecimiento(tipo, idSolicitud) {
    ...
    if (tipo !== '') {
        $.ajax({
            url: "solicitud.htm?action=selectClasEst&tipoEst=" + tipo + "&idSolici=" + idSolicitud,
            dataType: "json",
            success: function (result) {
    ...
    if (tipoPersona !== 0) {
        $.ajax({
            ...
            success: function (result) {
                ...
                //----dlarico
                if (tipoPersona === 2) {
                    cboDoc.append($('<option ></option>').val('').html('Seleccione'));
                }
                //----
                jQuery.each(result, function (a, b) {
...
function MostrarRed(idInstitucion) {
    ...
    //limpiar Combos
    $('#cboRedEst, #cboMicroRedEst, #cboUniEjeEst, #cboEstClasEst').empty();
    //$('#cboRedEst, #cboMicroRedEst').empty();
	$('#cboRedEst').append($('<option ></option>').val('').html('NO PERTENECE A NINGUNA RED'));//jcbt
	$('#cboMicroRedEst').append($('<option ></option>').val('').html('NO PERTENECE A NINGUNA MICRORED'));//jcbt
    if(idInstitucion === "10" || idInstitucion === "3" || idInstitucion === "4" ||
       ...
       idInstitucion === "13"){//caso SANIDAD EJERCITO, FUERZA AEREA, PNP, MARINA, APP, INPE y PRIVADO     
        ...
        if (idInstitucion === "2") {//caso ESSALUD
            ...
            $('#divRed, #divMicroRed, #divUE, #divEstClasEst').css('display', 'block');
            MostrarUniEjecutora(); //JCBT: solo se carga dependiendo de la unidad ejecutora
            MostrarEstabClas(); //jcbt: solo se carga dependiendo de la unidad ejecutora
        ...
        //--------------		
        $.ajax({
            url: "solicitud.htm?action=selectRed" + "&as=" +idAutoridad + "&institucion=" + idInstitucion,
            dataType: "json",
			async : false,
            success: function (result) {
...
function MostrarMicroRed(red) {
    ...
    var idAutoridad = $('#cboAutSanitaria').val();
    console.log('cboAutSanitaria =' + idAutoridad +', red:'+red);
    ...
    if ($(item).is(":checked")) {
		...
		if (upssItem != null && upssItem != undefined){
			...
			if (itemUPSS == null || itemUPSS == undefined ){
				...
				UPSSDatosAdicionales = Ordenamiento(UPSSDatosAdicionales, 'CO_IDUPSS', 'ASC');
...
function NuevoRRHH() {
	...
	if (idopcionValidar == 4){
		$('#frmDatosRRHHIndividual input[type="text"]').attr('disabled',false);
		$('#frmDatosRRHHIndividual select').attr('disabled',false);
...
$(function () {
        ...
        transport: {
            read: function (options) {
                ...
                if (idSolicEditar === "" || idSolicEditar === undefined) {
                    ruta = "solicitud.htm?action=cargarAdjuntosSolicitud&idAS=" + $('#cboIPAutoridadSanit').val();
                } else {
                    ruta = "solicitud.htm?action=cargarAdjuntosSolicitud&idSol=" + idSolicEditar + "&idAS=" + $('#cboIPAutoridadSanit').val();
                }
                $.ajax({
                    url: ruta,
                    dataType: "json",
        ...
        schema: {
            model: {
                fields: {
                    ...
                    FLAG_ENTRENAMIENTODETALLE:{
                        type: "string"
                    },
                    FLAG_CAPACITACIONDETALLE: {
                        type: "string"
                    },
                    FLAG_COMPETENCIADETALLE: {
                        type: "string"
                    }
                }
            }
    ...
    dsGdActividadesDA = new kendo.data.DataSource({
        transport: {
            read: function (options) {
                $.ajax({
                    url: "solicitud.htm?action=selectACTDA&idSol=" + $('#idSolicitud').val(),
                    dataType: "json",
                    success: function (result) {
	...
	dsGdEspecialidadSolicitudDA = new kendo.data.DataSource({
        transport: {
            read: function (options) {
                $.ajax({
                    url: "solicitud.htm?action=selectEspecialidadSolicitud&idSol=" + $('#idSolicitud').val(),
                    dataType: "json",
                    success: function (result) {
...
function CargarUPSDAdicional() {
    UPSDatosAdicionales = [];
    $.ajax({
        url: "solicitud.htm?action=selectUPSDA" + "&P_TIPOESTABLE=" + $('#cboTipoEstablecimiento').val() + "&idSolici=" + $('#idSolicitud').val(),
        dataType: "json",
        success: function (result) {
            var newArregloUPSS = [];
            UPSTemp = [];
...
function CargarUPSSDAdicional() {
    ...
    $.ajax({
        url: "solicitud.htm?action=selectUPSSDA" + "&P_TIPOESTABLE=" + $('#cboTipoEstablecimiento').val() + "&idSolici=" + $('#idSolicitud').val(),
        dataType: "json",
        success: function (result) {
            var newArregloUPSS = [];
            UPSSTemp = [];
...
function LanzarPopGenerico(titulo, mensaje, fn) {
    $('#lblTituloGenerico').text(titulo);
    $('#lblMensajeGenerico').text(mensaje);
...
function ValidaImprimirPDF() {
    ...
    if (flagValid) {
	    ...
	    if (ValidarFormularios()){
		if (arrModulosValidos.length == 0){
			LanzarPopGenerico('Informativo', 'Por favor registre las UPSS y complete la información de los requisitos');
			return;
		}
	    }else{
                    ...
                    keyboard: false
                        ...
                        function (e) {
                            if ($(this).data('value') === 1) {
                                beginCargando();
                                $.ajax({
                                    url: "solicitud.htm?action=ActualizarTarea&idSolicitudIPRESS=" + $('#idSolicitudIPRESS').val(),
                                    dataType: "json",
			    async : false,
                                    success: function (result) {
                                        endCargando();
...
function imprimirPDF() {
    $('#ifrReporte').attr('src','solicitud.htm?action=imprimirPDF&idSolicitud=' + $('#idSolicitud').val() );            
...
function fu_cargaGrillaRRHH(cursorRRHH) {
    //console.info("cursorRRHH:"+cursorRRHH);
...
function valDirectorMedico() {
	var object = {};
    $.ajax({
        url : "solicitud.htm?action=valDirectorMedico&tipoDocumento=" + $('#cboDocIdenRAS').val() + "&numeroDocumento=" + $('#txtNroDocRAS').val(),
        dataType : "json",		
        type: 'POST',
		async : false,
        success : function(result) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if ($.trim(estadoRuc) === "ACTIVO") {
                        ...
                        bootbox.alert("<p align='center'>" + IPRESS + "</p>" +
                                "El numero de RUC ingresado no se encuntra ACTIVO en SUNAT.");//bootbox.
                    }
                },
...
function activarTab(sw){
	var array = [
		'lbPropietario',
		'lbRepresentanteLegal',
		'lbEstablecimiento',
		'lbDirectorMedico',
		'lbRecursosHumanos',
		'lbDatosAdicionales',
		'lbPropietarioCheck',
		'lbRepresentanteLegalCheck',
		'lbEstablecimientoCheck',
		'lbDirectorMedicoCheck',
		'lbRecursosHumanosCheck',
		'lbDatosAdicionalesCheck'
	];
	...
	$.each(array, function(index, object){
		if (sw == true){
			...
			$('#' + object ).attr('data-toggle', 'collapse');
		}		
	});
}
...
$(document).ready(function(){
	/*
	$('#cboCuentaPoblacionDA').on('change', function(){
		fu_selectUpssMin();
	});
	
	$('#cboTipoEstablecimiento').on('change', function(){
		fu_selectUpssMin();
	});
	
	$('#cboTipoAtencionDA').on('change', function(){
		fu_selectUpssMin();
	});
	*/
});
...
/**----------------------------------**/
// AGREGADO POR CMIC 25/02/2016
/**----------------------------------**/

function selectUpssMin(){
	var sw = true;
	var condicion = $('#cboTipoEstablecimiento').val();
	var clasif = SeleccionASimple(arrClasEst, 3);
	var poblacion = $('#cboCuentaPoblacionDA').val();
	var atencion = $('#cboTipoAtencionDA').val();
	$.ajax({
		url: 'solicitud.htm?action=selectUpssMin',
		cache: false,
		async: true,
		type: 'POST',
		data: {
		...
		success: function (data) {
			var itemUPSS = [];
			var listaUpss = [];
			data['P_CURSOR'].forEach(function (item, num) {
				itemUPSS = SeleccionLike(arrUPPSSDASeleccion, 'idUPSS', item.IDUPSS)[0];
				if (itemUPSS != null || itemUPSS != undefined){
					listaUpss.push(item);
				}
			});
			
			if (listaUpss.length > 0){
				sw = false;
				
				var tablaReqVal = "<label style=" + '"color:red"' + ">Todas las UPSS mininas deben estar marcadas</label><br><br>";
				tablaReqVal += '<ul>';
				listaUpss.forEach(function (item, num) {
					tablaReqVal += '<li><div class="col-md-12"> ' + item.IDUPSS + ' - ' + item.DE_NOMBRE + '</div></li>';
				});
				tablaReqVal += '</ul>';
				tablaReqVal += '<br/><br/><br/><br/><br/><br/>';
				LanzarPopGenerico('Informativo', '');
...
function SeleccionASimple(arr, val) {
	var salida = 0;
    arr.forEach(function (element, index, array) {
        if (element === val) {
            salida = element;
...
function fnDownloadExcelCambiosSolicitud(idSolicitud){
    console.log("solicitud.htm?action=downloadExcelCambiosSolicitud&idSolicitud=" + idSolicitud);
    window.location.href = "solicitud.htm?action=downloadExcelCambiosSolicitud&idSolicitud=" + idSolicitud; 
    //return(false);
}
//------------------------------------------------------------
